...
class ScheduleDefinition(object):
    ...
    def __init__(
        ...
        check.opt_dict_param(tags, 'tags', key_type=check.string_types, value_type=str)
        ...
        check.opt_dict_param(environment_vars, 'environment_vars', key_type=check.string_types, value_type=str)
