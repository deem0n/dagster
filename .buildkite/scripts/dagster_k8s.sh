...
echo -e "--- \033[33m:k8s: Running kind cluster setup\033[0m"
...
echo -e "--- \033[33m:helm: Installing Helm and Helm chart\033[0m"
...
echo -e "--- \033[33m:k8s: Waiting for cluster ready\033[0m"
...
echo -e "--- \033[33m:python: Running tox tests\033[0m"
